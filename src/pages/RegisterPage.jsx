  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDFDFD] p-6">
      <div className="flex w-full max-w-4xl bg-white rounded-[2rem] shadow-2xl shadow-[#8EBAE3]/10 overflow-hidden border border-gray-50 flex-row-reverse">
        ...
        {/* Section de droite - Design et lien de connexion */}
        ...
        <div className="w-full md:w-7/12 flex flex-col justify-center p-8 md:p-12 bg-white">
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            {/* Numéro ADELI et Téléphone */}
            <div className="flex gap-3">
              <input type="text" name="adeliNumber" placeholder="N° ADELI / RPPS" onChange={handleChange} required className="w-1/2 px-5 py-3 bg-[#F8FAFC] rounded-2xl text-sm outline-none focus:ring-2 focus:ring-[#8EBAE3]" />
              <input type="text" name="phone" placeholder="Téléphone" onChange={handleChange} required className="w-1/2 px-5 py-3 bg-[#F8FAFC] rounded-2xl text-sm outline-none focus:ring-2 focus:ring-[#8EBAE3]" />
            </div>
            ...
            <button type="submit" disabled={loading} className="w-full bg-[#8EBAE3] text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest mt-2 hover:shadow-lg transition-all">
          ...
          <button onClick={handleGoogleLogin} type="button" className="w-full flex items-center justify-center gap-4 border-2 border-gray-100 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:border-[#8EBAE3] transition-all">
